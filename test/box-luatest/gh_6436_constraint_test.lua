...
local g = t.group('gh-6436-constraint-test', {{engine = 'memtx'}, {engine = 'vinyl'}})
...
g.test_field_constraint_basics = function(cg)
    ...
    local function test_lua(cg, field4)
        t.assert_equals(cg.server:exec(function(field4)
            return box.space.test:replace{1, 2, 3, field4}
        end, {field4}), {1, 2, 3, field4})
        t.assert_error_msg_content_equals(
            "Check constraint 'field_constr1' failed for field '1 (id1)'",
            function(field4)
                cg.server:exec(function(field4)
                    return box.space.test:replace{100, 2, 3, field4}
                end, {field4})
            end)
        t.assert_error_msg_content_equals(
            ...
            function()
                cg.server:exec(function()
                    return box.space.test:replace{1, 200, 3}
                end, {field4})
            end)
        t.assert_error_msg_content_equals(
            ...
            function()
                cg.server:exec(function()
                    return box.space.test:replace{1, 2, 300}
                end, {field4})
            end)
...
g.test_wrong_field_constraint = function(cg)
    ...
    t.assert_error_msg_content_equals(
        "Illegal parameters, format[1]: constraint function was not found by name 'field_constr4'",
        function() cg.server:exec(function()
    ...
    t.assert_error_msg_content_equals(
        "Illegal parameters, format[1]: constraint must be string or table",
        function() cg.server:exec(function()
    ...
    t.assert_error_msg_content_equals(
        "Illegal parameters, format[1]: constraint function is expected to be a string, but got number",
        function() cg.server:exec(function()
            box.space.test:format({{"id1", constraint = {666}}, {"id2"}})
        end)
    end)
    ...
    local func_id = cg.server:exec(function() return box.func.field_constr1.id end)
    t.assert_equals(cg.server:exec(function()
        return box.space.test:format()
    end), { {constraint = {field_constr1 = func_id},
             name = "id1", type = "any"},
            {name = "id2", type = "any"} })
end
