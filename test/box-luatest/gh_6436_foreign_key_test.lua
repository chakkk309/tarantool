...
g.test_foreign_key_primary = function(cg)
    ...
    cg.server:exec(function(engine)
        ...
        t.assert_equals(country:select{}, {{1, 'ru', 'Russia'}, {2, 'fr', 'France'}})
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country' failed for field '2 (country_id)': foreign index was not found",
        ...
        country:format(fmt)
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country' failed for field '2 (country_id)': foreign tuple was not found",
...
g.test_foreign_key_secondary = function(cg)
    ...
    cg.server:exec(function(engine)
        ...
        t.assert_equals(country:select{}, {{1, 'ru', 'Russia'}, {2, 'fr', 'France'}})
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country' failed for field '2 (country_code)': foreign index was not found",
        ...
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country' failed for field '2 (country_code)': foreign tuple was not found",
...
g.test_foreign_key_wrong_type = function(cg)
    ...
    cg.server:exec(function(engine)
        ...
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country2' failed for field '3 (country_code)': wrong key type",
            function() city:replace{1,1,1} end
        )
        t.assert_error_msg_content_equals(
            "Foreign key constraint 'country1' failed for field '2 (country_id)': wrong key type",
